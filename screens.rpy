...
screen main_menu():
    ...
    imagebutton auto "gui/friends_%s.png" action ShowMenu('about2') pos (20, 525) at menumove
...
screen about2():
    tag menu
    use game_menu(_("Potential Friends"), scroll="viewport"):

        style_prefix "about"

        vbox:
            add "images/preview.png"
...
screen troll_select1():
    ...
    imagebutton auto "images/naxili_button_%s.png" action Jump("naxili") pos (0, 0)
    imagebutton auto "images/hefais_button_%s.png" action Jump("hefais") pos (640, 0)
